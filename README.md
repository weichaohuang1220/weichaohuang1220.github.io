...
All 26 steps (DynaFace 4, MiniMind 8, ChatMind 14) have numbered controls and matching individually colored explanation frames. Architecture frame borders follow the selected step; disabled-file and proposed-harness route colors retain their original meaning. Maps, implementation details, and animation areas remain inline.
